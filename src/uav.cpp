...
//#include </opt/ros/indigo/include/opencv2/imgproc/imgproc.hpp>
//#include </opt/ros/indigo/include/opencv2/highgui/highgui.hpp>
#include <opencv/cv.h>
#include <stdio.h>
#include <stdlib.h>
...
void track_ugv(double time){ 
    ...
    for(q=0; q<time; q++){
		...
		Kd_yaw = D_yaw;
		// ############## Pitch PID   #####################
		double P_pitch=((-.0005*constant)*(nyc_red-250));
		error_pitch = yc_red;
